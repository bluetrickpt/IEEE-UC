...
//$mail->addCC('');
 if(!$mail->Send()){
	...
	echo "Infelizmente as inscricoes terminaram. ";
    echo "Obrigado.. Vamos registar a tua inscricao, contactamos em caso de alguma desistencia.";
